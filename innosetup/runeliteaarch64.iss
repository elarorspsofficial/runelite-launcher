...
[Files]
Source: "${project.projectDir}\build\win-aarch64\Zenyte.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "${project.projectDir}\build\win-aarch64\Zenyte.jar"; DestDir: "{app}"
