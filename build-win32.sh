...
cp native/build-x86/src/Release/Zenyte.exe build/win-x86/
cp build/libs/Zenyte.jar build/win-x86/
...
sha256sum build/win-x86/Zenyte.exe

dumpbin //HEADERS build/win-x86/Zenyte.exe
