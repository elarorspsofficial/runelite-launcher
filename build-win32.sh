...
cp native/build-x86/src/Release/Elaro.exe build/win-x86/
cp build/libs/Elaro.jar build/win-x86/
...
echo Elaro.exe 32bit sha256sum
sha256sum build/win-x86/Elaro.exe

dumpbin //HEADERS build/win-x86/Elaro.exe
