...
sha256sum build/libs/Zenyte.jar
...
cp native/build-x64/src/Release/Zenyte.exe build/win-x64/
cp build/libs/Zenyte.jar build/win-x64/
...
sha256sum build/win-x64/Zenyte.exe

dumpbin //HEADERS build/win-x64/Zenyte.exe
