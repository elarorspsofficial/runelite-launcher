...
cp native/build-x64/src/Release/Elaro.exe build/win-x64/
cp build/libs/Elaro.jar build/win-x64/
...
echo Elaro.exe 64bit sha256sum
sha256sum build/win-x64/Elaro.exe

dumpbin //HEADERS build/win-x64/Elaro.exe
